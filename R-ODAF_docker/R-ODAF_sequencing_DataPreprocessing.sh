...
SEQTYPE="RNASeq"
# If you wish to run TempO-Seq analysis, the supplied scripts must also be loaded in a Docker volume.
TEMPOSEQR="/scripts/temposeqr_v3.1.R"
TEMPOSEQFIGS="/scripts/generate_figures.R"
